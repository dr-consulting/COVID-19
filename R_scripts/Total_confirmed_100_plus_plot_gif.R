...
countries_to_view <- c("US", "China", "Italy", "Spain", "United Kingdom", "Korea, South", "Germany", "Iran", "France")
...
line_plot <- ggplot(data=centered_countries_100_or_more_long[centered_countries_100_or_more_long$ctry_plot=="Other",]) +
  geom_line(aes(x=day_centered, y=value, group=Country.Region), alpha=.65, color="grey") +
  geom_line(data=centered_countries_100_or_more_long[centered_countries_100_or_more_long$ctry_plot!="Other",], 
            aes(x=day_centered, y=value, group=Country.Region, color=ctry_plot), show.legend = FALSE) +
  geom_text(data=centered_countries_100_or_more_long[centered_countries_100_or_more_long$ctry_plot!="Other",], 
...
animated_line_plot <- animate(line_plot)

magick::image_write(animated_line_plot, "~/COVID-19/graphics/Total_cases_animated.gif")
